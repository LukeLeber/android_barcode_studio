...
import static com.lukeleber.barcodestudio.rendering.PrintingMedia.Orientation.LANDSCAPE;
 ...
 */
public class PrintingMediaSettings
        extends Activity
{
    ...
    {
        pageSetup = new PrintingMedia(new PrintingMedia.Configuration());
        updateGUI();
    }
    ...
    private PrintingMedia pageSetup;
