        ...
        extends Serializable
{
    ...
    /**
     * Retrieves the character set that is used in this Symbology.  Note that the character set that
     * is returned may depend on the configuration options of a particular symbology (IE. some
            ...
            implements Serializable
    {
         ...
         *
         * @param enabled
         *         should the extended charset be enabled?
         *
         * @return this
         */
         ...
         *
         * @param enabled
         *         should the checksum be enabled?
         *
         * @return this
         */
