        ...
        extends ClassLoader
{
     ...
     *
     * @param context
     *         a reference to the Context of the current Activity
     *
     * @throws IOException
     *         if the DEX file could not be opened
     */
    ...
    /**
     * Retrieves a collection of all classes in the provided package (or sub-packages therein) that
     * are assignable to the provided class.
     *
     * @param pkg
